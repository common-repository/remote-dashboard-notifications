...
= 1.2.0 - September 15, 2015 =

* New
	* Add start and end dates for notifications
	* Show start and end dates in the notifications list view

* Improvements
	* Partly refactor the client class for better clarity
	* Notifications are dismissed per user and no longer sitewide
